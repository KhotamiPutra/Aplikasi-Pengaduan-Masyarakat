        ...
        <div class="bg-white rounded-2xl shadow-lg overflow-hidden">
            <div class="p-8">
                <div class="flex items-center justify-between mb-8">
                    ...
                    <a href="{{ route('MasterPetugas') }}" class="text-gray-500 hover:text-gray-700 transition-colors">
                ...
                <form action="{{ route('petugas.update', $putra_petugas->id_petugas) }}" method="POST" class="space-y-6">
                    @csrf
                    @method('PUT')
                    <div class="flex flex-col md:flex-row gap-4">
                        <div class="flex-1 space-y-1">
                            ...
                            <input type="text" id="putra_nama" name="putra_nama" value="{{ old('putra_nama', $putra_petugas->nama_petugas) }}"
                        ...
                        <div class="flex-1 space-y-1">
                            ...
                            <input type="text" id="putra_username" name="putra_username" value="{{ old('putra_username', $putra_petugas->username) }}"
                    ...
                    <div class="space-y-1">
                        ...
                        <div class="relative">
                            <input type="password" id="putra_password" name="putra_password"
                            ...
                            <button type="button" onclick="togglePassword()"
                                ...
                                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" id="password-icon"
                    ...
                    <div class="space-y-1">
                        ...
                        <input type="text" id="putra_telp" name="putra_telp" value="{{ old('putra_telp', $putra_petugas->telp) }}"
                    ...
                    <div class="space-y-1">
                        <label for="putra_level" class="block text-sm font-medium text-gray-700">
                            Level
                        </label>
                        <select name="putra_level" id="putra_level"
                            class="mt-1 block w-full px-4 py-3 bg-gray-50 border border-gray-300 rounded-lg text-gray-900 text-sm focus:ring-2 focus:ring-indigo-500 focus:border-transparent">
                            <option value="admin" {{ old('putra_level', $putra_petugas->level) == 'admin' ? 'selected' : '' }}>Admin</option>
                            <option value="petugas" {{ old('putra_level', $putra_petugas->level) == 'petugas' ? 'selected' : '' }}>Petugas</option>
                        </select>
                        @error('putra_level')
                            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                        @enderror

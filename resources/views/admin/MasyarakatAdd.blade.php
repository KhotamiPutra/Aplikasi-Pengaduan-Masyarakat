            ...
            <div class="bg-white rounded-2xl shadow-lg overflow-hidden">
                <div class="p-8">
                    <div class="flex items-center justify-between mb-8">
                        <h2 class="text-2xl font-bold text-gray-800">Tambah Masyarakat</h2>
                    ...
                    <form action="{{ route('masyarakat.store') }}" method="POST" class="space-y-6">
                        ...
                        <div class="flex flex-col md:flex-row gap-4">
                            <div class="flex-1 space-y-1">
                                ...
                                <input type="text" id="putra_nik" name="putra_nik" value="{{ old('putra_nik') ?? '' }}"
                                    oninput="this.value = this.value.replace(/[^0-9]/g, '')"
                                    class="mt-1 block w-full px-4 py-3 bg-gray-50 border border-gray-300 rounded-lg text-gray-900 text-sm transition duration-150 ease-in-out focus:ring-2 focus:ring-indigo-500 focus:border-transparent @error('putra_nik') border-red-500 bg-red-50 @enderror"
                                    placeholder="NIK" />
                                @error('putra_nik')
                            ...
                            <div class="flex-1 space-y-1">
                                ...
                                <input type="text" id="putra_nama" name="putra_nama"
                        ...
                        <div class="space-y-1">
                            ...
                            <input type="text" id="putra_username" name="putra_username"

                ...
                <form action="{{ route('petugas.store') }}" method="POST" class="space-y-6">
                    ...
                    <div class="flex flex-col md:flex-row gap-4">
                        <div class="flex-1 space-y-1">
                            ...
                            <input type="text" id="putra_nama" name="putra_nama" value="{{ old('putra_nama') ?? '' }}"
                        ...
                        <div class="flex-1 space-y-1">
                            ...
                            <input type="text" id="putra_username" name="putra_username" value="{{ old('putra_username') ?? '' }}"
                    ...
                    <div class="space-y-1">
                        ...
                        <input type="text" id="putra_telp" name="putra_telp" value="{{ old('putra_telp') ?? '' }}"

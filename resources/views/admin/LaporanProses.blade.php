                    ...
                    <div class="bg-white rounded-lg shadow-md overflow-hidden">
                        <div class="p-4">
                            ...
                            <div class="mb-2">
                                ...
                                <p class="text-sm text-gray-800 mt-1">{{ Str::limit($pengaduan->isi_laporan, 50)  }}</p>
                            </div>
                            <div class="mb-2">
                            ...
                            <div class="mb-2">
                                ...
                                <span
                                    class="text-sm text-gray-800 ml-2">{{ $pengaduan->putra_masyarakat->nik ?? '-' }}</span>
                            </div>
                            <div class="mb-4">
                                <span class="text-sm font-semibold text-gray-600">Username:</span>
                                <span
                                    class="text-sm text-gray-800 ml-2">{{ $pengaduan->putra_masyarakat->username ?? '-' }}</span>
                            </div>

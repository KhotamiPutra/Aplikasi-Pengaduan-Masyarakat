                    ...
                    <div class="bg-white rounded-lg shadow-md overflow-hidden">
                        <div class="p-4">
                            ...
                            <div class="mb-2">
                                ...
                                <p class="text-sm text-gray-800 mt-1">{{ Str::limit(Str::limit($pengaduan->isi_laporan, 50)) }}</p>
                            </div>
                            <div class="mb-2">
                            ...
                            <div class="flex justify-between">
                                <a href="{{ route('Petugaslaporan.tanggapan.create', $pengaduan->id_pengaduan) }}" class="bg-[#D97757] text-white px-3 py-1 rounded hover:bg-[#bf6443] text-sm">Tanggapan</a>
                            </div>
                        </div>
                    </div>
                @endforeach

                    ...
                    <div class="bg-white rounded-lg shadow-md overflow-hidden">
                        <div class="p-4">
                            ...
                            <div class="flex justify-between">
                                <a href="{{ route('laporanSelesai.Petugas', $pengaduan->id_pengaduan) }}" class="bg-green-500 text-white px-3 py-1 rounded hover:bg-green-600 text-sm">Selesai</a>
                                <a href="/petugas/laporan/tanggapan/{{ $pengaduan->id_pengaduan }}" class="bg-[#D97757] text-white px-3 py-1 rounded hover:bg-[#bf6443] text-sm">Tanggapan</a>
                            </div>
                        </div>
                    </div>
                @endforeach

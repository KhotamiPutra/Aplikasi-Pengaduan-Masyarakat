...
@section('content')
    <div class="container mx-auto px-4 py-8">
        ...
        <div class="bg-white shadow-md rounded-lg p-6">
            <p class="mb-4"><strong>Tanggal Pengaduan:</strong> {{ $pengaduan->tgl_pengaduan }}</p>
            <p class="mb-4"><strong>Isi Laporan:</strong> {{ $pengaduan->isi_laporan }}</p>

            <form action="{{ route('tanggapan.store', $pengaduan->id_pengaduan) }}" method="POST" class="mb-8">
                @csrf
                <textarea name="tanggapan" class="w-full border rounded p-2" placeholder="Tulis tanggapan..."></textarea>

                    ...
                    <div class="bg-white rounded-lg shadow-md overflow-hidden">
                        <div class="p-4">
                            ...
                            <div class="flex justify-between">
                                <a href="{{ route('laporan.konfirmasPet', $putra_pengaduan_item->id_pengaduan) }}" class="bg-green-500 text-white px-3 py-1 rounded hover:bg-green-600 text-sm">Proses</a>
